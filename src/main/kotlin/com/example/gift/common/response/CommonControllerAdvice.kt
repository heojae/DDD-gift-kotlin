...
class CommonControllerAdvice {
    ...
    fun onBaseException(e: BaseException): CommonResponse<String> {
        val eventId: String = MDC.get(CommonHttpRequestInterceptor.HEADER_REQUEST_UUID_KEY)
        println(eventId)
        println(e)
    ...
    fun skipException(e: Exception): CommonResponse<String> {
        val eventId: String = MDC.get(CommonHttpRequestInterceptor.HEADER_REQUEST_UUID_KEY)
        println(eventId)
        println(e)
        return CommonResponse.fail(ErrorCode.COMMON_SYSTEM_ERROR)
